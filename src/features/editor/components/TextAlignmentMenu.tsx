...
export const TextAlignmentMenu = () => {
    ...
    return <div className="absolute flex right-0 bottom-full w-max bg-[rgba(14,14,17,1)] rounded-2xl border border-white/5 shadow-[0px_16px_48px_0px_rgba(0,0,0,0.5),0px_12px_24px_0px_rgba(0,0,0,0.24),0px_6px_8px_0px_rgba(0,0,0,0.22),0px_2px_3px_0px_rgba(0,0,0,0.12)] p-1 my-1 ">
        <div>
            <ToolbarButton button={"superscript"} icon={<PiTextSuperscript />}>
            </ToolbarButton>
        </div>
        <div>
            <ToolbarButton button={"subscript"} icon={<PiTextSubscript />}>
            </ToolbarButton>
        </div>
        ...
        <div>
            <ToolbarButton button={"textAlign-left"} icon={<LuAlignLeft />}>
            </ToolbarButton>
        </div>
        <div>
            <ToolbarButton button={"textAlign-center"} icon={<LuAlignCenter />}>
            </ToolbarButton>
        </div>
        <div>
            <ToolbarButton button={"textAlign-right"} icon={<LuAlignRight />}>
            </ToolbarButton>
        </div>
        <div>
            <ToolbarButton button={"textAlign-justify"} icon={<LuAlignJustify />}>
            </ToolbarButton>
        </div>
    </div>
}
